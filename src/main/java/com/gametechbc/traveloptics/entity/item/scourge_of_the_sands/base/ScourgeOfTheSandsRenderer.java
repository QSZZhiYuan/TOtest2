...
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.base.ScourgeOfTheSandsLayer;
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.base.ScourgeOfTheSandsModel;
...
public class ScourgeOfTheSandsRenderer
extends GeoItemRenderer<ScourgeOfTheSandsItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ScourgeOfTheSandsItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ScourgeOfTheSandsRenderer() {
        super((GeoModel)new ScourgeOfTheSandsModel());
        this.addRenderLayer(new ScourgeOfTheSandsLayer((GeoRenderer<ScourgeOfTheSandsItem>)this));
    }

    public RenderType getRenderType(ScourgeOfTheSandsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ScourgeOfTheSandsItem instance) {
