...
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_one.TheObliteratorLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_one.TheObliteratorLevelOneModel;
...
public class TheObliteratorLevelOneRenderer
extends GeoItemRenderer<TheObliteratorLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TheObliteratorLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TheObliteratorLevelOneRenderer() {
        super((GeoModel)new TheObliteratorLevelOneModel());
        this.addRenderLayer(new TheObliteratorLevelOneLayer((GeoRenderer<TheObliteratorLevelOneItem>)this));
    }

    public RenderType getRenderType(TheObliteratorLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TheObliteratorLevelOneItem instance) {
