...
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.evo_three.ThornsOfOblivionLevelThreeLayer;
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.evo_three.ThornsOfOblivionLevelThreeModel;
...
public class ThornsOfOblivionLevelThreeRenderer
extends GeoItemRenderer<ThornsOfOblivionLevelThreeItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ThornsOfOblivionLevelThreeItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ThornsOfOblivionLevelThreeRenderer() {
        super((GeoModel)new ThornsOfOblivionLevelThreeModel());
        this.addRenderLayer(new ThornsOfOblivionLevelThreeLayer((GeoRenderer<ThornsOfOblivionLevelThreeItem>)this));
    }

    public RenderType getRenderType(ThornsOfOblivionLevelThreeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ThornsOfOblivionLevelThreeItem instance) {
