...
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_two.FlamesOfEldritchLevelTwoLayer;
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_two.FlamesOfEldritchLevelTwoModel;
...
public class FlamesOfEldritchLevelTwoRenderer
extends GeoItemRenderer<FlamesOfEldritchLevelTwoItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected FlamesOfEldritchLevelTwoItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public FlamesOfEldritchLevelTwoRenderer() {
        super((GeoModel)new FlamesOfEldritchLevelTwoModel());
        this.addRenderLayer(new FlamesOfEldritchLevelTwoLayer((GeoRenderer<FlamesOfEldritchLevelTwoItem>)this));
    }

    public RenderType getRenderType(FlamesOfEldritchLevelTwoItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(FlamesOfEldritchLevelTwoItem instance) {
