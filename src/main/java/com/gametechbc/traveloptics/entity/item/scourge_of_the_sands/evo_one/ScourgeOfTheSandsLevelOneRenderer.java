...
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.evo_one.ScourgeOfTheSandsLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.evo_one.ScourgeOfTheSandsLevelOneModel;
...
public class ScourgeOfTheSandsLevelOneRenderer
extends GeoItemRenderer<ScourgeOfTheSandsLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ScourgeOfTheSandsLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ScourgeOfTheSandsLevelOneRenderer() {
        super((GeoModel)new ScourgeOfTheSandsLevelOneModel());
        this.addRenderLayer(new ScourgeOfTheSandsLevelOneLayer((GeoRenderer<ScourgeOfTheSandsLevelOneItem>)this));
    }

    public RenderType getRenderType(ScourgeOfTheSandsLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ScourgeOfTheSandsLevelOneItem instance) {
