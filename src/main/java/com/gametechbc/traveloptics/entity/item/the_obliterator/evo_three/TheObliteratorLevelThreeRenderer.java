...
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_three.TheObliteratorLevelThreeLayer;
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_three.TheObliteratorLevelThreeModel;
...
public class TheObliteratorLevelThreeRenderer
extends GeoItemRenderer<TheObliteratorLevelThreeItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TheObliteratorLevelThreeItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TheObliteratorLevelThreeRenderer() {
        super((GeoModel)new TheObliteratorLevelThreeModel());
        this.addRenderLayer(new TheObliteratorLevelThreeLayer((GeoRenderer<TheObliteratorLevelThreeItem>)this));
    }

    public RenderType getRenderType(TheObliteratorLevelThreeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TheObliteratorLevelThreeItem instance) {
