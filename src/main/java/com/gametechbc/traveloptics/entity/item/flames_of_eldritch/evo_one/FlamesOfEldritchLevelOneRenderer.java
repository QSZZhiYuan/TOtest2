...
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_one.FlamesOfEldritchLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_one.FlamesOfEldritchLevelOneModel;
...
public class FlamesOfEldritchLevelOneRenderer
extends GeoItemRenderer<FlamesOfEldritchLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected FlamesOfEldritchLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public FlamesOfEldritchLevelOneRenderer() {
        super((GeoModel)new FlamesOfEldritchLevelOneModel());
        this.addRenderLayer(new FlamesOfEldritchLevelOneLayer((GeoRenderer<FlamesOfEldritchLevelOneItem>)this));
    }

    public RenderType getRenderType(FlamesOfEldritchLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(FlamesOfEldritchLevelOneItem instance) {
