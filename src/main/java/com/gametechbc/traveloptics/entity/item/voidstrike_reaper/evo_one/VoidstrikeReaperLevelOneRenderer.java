...
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.evo_one.VoidstrikeReaperLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.evo_one.VoidstrikeReaperLevelOneModel;
...
public class VoidstrikeReaperLevelOneRenderer
extends GeoItemRenderer<VoidstrikeReaperLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected VoidstrikeReaperLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public VoidstrikeReaperLevelOneRenderer() {
        super((GeoModel)new VoidstrikeReaperLevelOneModel());
        this.addRenderLayer(new VoidstrikeReaperLevelOneLayer((GeoRenderer<VoidstrikeReaperLevelOneItem>)this));
    }

    public RenderType getRenderType(VoidstrikeReaperLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(VoidstrikeReaperLevelOneItem instance) {
