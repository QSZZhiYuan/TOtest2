...
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.evo_one.ThornsOfOblivionLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.evo_one.ThornsOfOblivionLevelOneModel;
...
public class ThornsOfOblivionLevelOneRenderer
extends GeoItemRenderer<ThornsOfOblivionLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ThornsOfOblivionLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ThornsOfOblivionLevelOneRenderer() {
        super((GeoModel)new ThornsOfOblivionLevelOneModel());
        this.addRenderLayer(new ThornsOfOblivionLevelOneLayer((GeoRenderer<ThornsOfOblivionLevelOneItem>)this));
    }

    public RenderType getRenderType(ThornsOfOblivionLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ThornsOfOblivionLevelOneItem instance) {
