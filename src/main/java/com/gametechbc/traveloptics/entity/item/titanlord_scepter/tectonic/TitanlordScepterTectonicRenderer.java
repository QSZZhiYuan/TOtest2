...
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.tectonic.TitanlordScepterTectonicLayer;
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.tectonic.TitanlordScepterTectonicModel;
...
public class TitanlordScepterTectonicRenderer
extends GeoItemRenderer<TitanlordScepterTectonicItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TitanlordScepterTectonicItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TitanlordScepterTectonicRenderer() {
        super((GeoModel)new TitanlordScepterTectonicModel());
        this.addRenderLayer(new TitanlordScepterTectonicLayer((GeoRenderer<TitanlordScepterTectonicItem>)this));
    }

    public RenderType getRenderType(TitanlordScepterTectonicItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TitanlordScepterTectonicItem instance) {
