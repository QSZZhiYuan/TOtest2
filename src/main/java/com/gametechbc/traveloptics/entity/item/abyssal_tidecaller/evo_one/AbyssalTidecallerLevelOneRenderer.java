...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_one.AbyssalTidecallerLevelOneLayer;
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_one.AbyssalTidecallerLevelOneModel;
...
public class AbyssalTidecallerLevelOneRenderer
extends GeoItemRenderer<AbyssalTidecallerLevelOneItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected AbyssalTidecallerLevelOneItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public AbyssalTidecallerLevelOneRenderer() {
        super((GeoModel)new AbyssalTidecallerLevelOneModel());
        this.addRenderLayer(new AbyssalTidecallerLevelOneLayer((GeoRenderer<AbyssalTidecallerLevelOneItem>)this));
    }

    public RenderType getRenderType(AbyssalTidecallerLevelOneItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(AbyssalTidecallerLevelOneItem instance) {
