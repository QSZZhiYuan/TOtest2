...
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.base.TitanlordScepterLayer;
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.base.TitanlordScepterModel;
...
public class TitanlordScepterRenderer
extends GeoItemRenderer<TitanlordScepterItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TitanlordScepterItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TitanlordScepterRenderer() {
        super((GeoModel)new TitanlordScepterModel());
        this.addRenderLayer(new TitanlordScepterLayer((GeoRenderer<TitanlordScepterItem>)this));
    }

    public RenderType getRenderType(TitanlordScepterItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TitanlordScepterItem instance) {
