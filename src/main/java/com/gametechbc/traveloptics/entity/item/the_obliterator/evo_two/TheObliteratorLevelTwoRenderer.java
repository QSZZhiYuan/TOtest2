...
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_two.TheObliteratorLevelTwoLayer;
import com.gametechbc.traveloptics.entity.item.the_obliterator.evo_two.TheObliteratorLevelTwoModel;
...
public class TheObliteratorLevelTwoRenderer
extends GeoItemRenderer<TheObliteratorLevelTwoItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TheObliteratorLevelTwoItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TheObliteratorLevelTwoRenderer() {
        super((GeoModel)new TheObliteratorLevelTwoModel());
        this.addRenderLayer(new TheObliteratorLevelTwoLayer((GeoRenderer<TheObliteratorLevelTwoItem>)this));
    }

    public RenderType getRenderType(TheObliteratorLevelTwoItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TheObliteratorLevelTwoItem instance) {
