...
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.evo_three.ScourgeOfTheSandsLevelThreeLayer;
import com.gametechbc.traveloptics.entity.item.scourge_of_the_sands.evo_three.ScourgeOfTheSandsLevelThreeModel;
...
public class ScourgeOfTheSandsLevelThreeRenderer
extends GeoItemRenderer<ScourgeOfTheSandsLevelThreeItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ScourgeOfTheSandsLevelThreeItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ScourgeOfTheSandsLevelThreeRenderer() {
        super((GeoModel)new ScourgeOfTheSandsLevelThreeModel());
        this.addRenderLayer(new ScourgeOfTheSandsLevelThreeLayer((GeoRenderer<ScourgeOfTheSandsLevelThreeItem>)this));
    }

    public RenderType getRenderType(ScourgeOfTheSandsLevelThreeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ScourgeOfTheSandsLevelThreeItem instance) {
