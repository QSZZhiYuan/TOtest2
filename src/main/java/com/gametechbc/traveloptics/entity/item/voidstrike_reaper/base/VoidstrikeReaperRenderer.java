...
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.base.VoidstrikeReaperLayer;
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.base.VoidstrikeReaperModel;
...
public class VoidstrikeReaperRenderer
extends GeoItemRenderer<VoidstrikeReaperItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected VoidstrikeReaperItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public VoidstrikeReaperRenderer() {
        super((GeoModel)new VoidstrikeReaperModel());
        this.addRenderLayer(new VoidstrikeReaperLayer((GeoRenderer<VoidstrikeReaperItem>)this));
    }

    public RenderType getRenderType(VoidstrikeReaperItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(VoidstrikeReaperItem instance) {
