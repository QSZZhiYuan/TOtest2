...
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.evo_two.VoidstrikeReaperLevelTwoLayer;
import com.gametechbc.traveloptics.entity.item.voidstrike_reaper.evo_two.VoidstrikeReaperLevelTwoModel;
...
public class VoidstrikeReaperLevelTwoRenderer
extends GeoItemRenderer<VoidstrikeReaperLevelTwoItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected VoidstrikeReaperLevelTwoItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public VoidstrikeReaperLevelTwoRenderer() {
        super((GeoModel)new VoidstrikeReaperLevelTwoModel());
        this.addRenderLayer(new VoidstrikeReaperLevelTwoLayer((GeoRenderer<VoidstrikeReaperLevelTwoItem>)this));
    }

    public RenderType getRenderType(VoidstrikeReaperLevelTwoItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(VoidstrikeReaperLevelTwoItem instance) {
