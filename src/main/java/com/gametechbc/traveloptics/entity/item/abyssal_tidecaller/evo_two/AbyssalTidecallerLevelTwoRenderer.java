...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_two.AbyssalTidecallerLevelTwoLayer;
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_two.AbyssalTidecallerLevelTwoModel;
...
public class AbyssalTidecallerLevelTwoRenderer
extends GeoItemRenderer<AbyssalTidecallerLevelTwoItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected AbyssalTidecallerLevelTwoItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public AbyssalTidecallerLevelTwoRenderer() {
        super((GeoModel)new AbyssalTidecallerLevelTwoModel());
        this.addRenderLayer(new AbyssalTidecallerLevelTwoLayer((GeoRenderer<AbyssalTidecallerLevelTwoItem>)this));
    }

    public RenderType getRenderType(AbyssalTidecallerLevelTwoItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(AbyssalTidecallerLevelTwoItem instance) {
