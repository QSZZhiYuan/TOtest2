...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.base.AbyssalTidecallerLayer;
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.base.AbyssalTidecallerModel;
...
public class AbyssalTidecallerRenderer
extends GeoItemRenderer<AbyssalTidecallerItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected AbyssalTidecallerItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public AbyssalTidecallerRenderer() {
        super((GeoModel)new AbyssalTidecallerModel());
        this.addRenderLayer(new AbyssalTidecallerLayer((GeoRenderer<AbyssalTidecallerItem>)this));
    }

    public RenderType getRenderType(AbyssalTidecallerItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(AbyssalTidecallerItem instance) {
