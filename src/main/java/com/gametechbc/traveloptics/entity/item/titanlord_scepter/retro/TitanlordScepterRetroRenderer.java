...
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.retro.TitanlordScepterRetroLayer;
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.retro.TitanlordScepterRetroModel;
...
public class TitanlordScepterRetroRenderer
extends GeoItemRenderer<TitanlordScepterRetroItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TitanlordScepterRetroItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TitanlordScepterRetroRenderer() {
        super((GeoModel)new TitanlordScepterRetroModel());
        this.addRenderLayer(new TitanlordScepterRetroLayer((GeoRenderer<TitanlordScepterRetroItem>)this));
    }

    public RenderType getRenderType(TitanlordScepterRetroItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TitanlordScepterRetroItem instance) {
