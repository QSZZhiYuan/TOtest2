...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_three.AbyssalTidecallerLevelThreeLayer;
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_three.AbyssalTidecallerLevelThreeModel;
...
public class AbyssalTidecallerLevelThreeRenderer
extends GeoItemRenderer<AbyssalTidecallerLevelThreeItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected AbyssalTidecallerLevelThreeItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public AbyssalTidecallerLevelThreeRenderer() {
        super((GeoModel)new AbyssalTidecallerLevelThreeModel());
        this.addRenderLayer(new AbyssalTidecallerLevelThreeLayer((GeoRenderer<AbyssalTidecallerLevelThreeItem>)this));
    }

    public RenderType getRenderType(AbyssalTidecallerLevelThreeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(AbyssalTidecallerLevelThreeItem instance) {
