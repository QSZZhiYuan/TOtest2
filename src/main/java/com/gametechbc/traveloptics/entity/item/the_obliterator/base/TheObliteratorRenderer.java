...
import com.gametechbc.traveloptics.entity.item.the_obliterator.base.TheObliteratorLayer;
import com.gametechbc.traveloptics.entity.item.the_obliterator.base.TheObliteratorModel;
...
extends GeoItemRenderer<TheObliteratorItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected TheObliteratorItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public TheObliteratorRenderer() {
        super((GeoModel)new TheObliteratorModel());
        this.addRenderLayer(new TheObliteratorLayer((GeoRenderer<TheObliteratorItem>)this));
    }

    public RenderType getRenderType(TheObliteratorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(TheObliteratorItem instance) {
