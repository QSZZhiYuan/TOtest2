...
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.base.ThornsOfOblivionLayer;
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.base.ThornsOfOblivionModel;
...
public class ThornsOfOblivionRenderer
extends GeoItemRenderer<ThornsOfOblivionItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected ThornsOfOblivionItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public ThornsOfOblivionRenderer() {
        super((GeoModel)new ThornsOfOblivionModel());
        this.addRenderLayer(new ThornsOfOblivionLayer((GeoRenderer<ThornsOfOblivionItem>)this));
    }

    public RenderType getRenderType(ThornsOfOblivionItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(ThornsOfOblivionItem instance) {
