...
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_three.FlamesOfEldritchLevelThreeLayer;
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_three.FlamesOfEldritchLevelThreeModel;
...
public class FlamesOfEldritchLevelThreeRenderer
extends GeoItemRenderer<FlamesOfEldritchLevelThreeItem> {
    private static final float SCALE_RECIPROCAL = 0.0625f;
    protected boolean renderArms = false;
    protected MultiBufferSource currentBuffer;
    protected RenderType renderType;
    public ItemDisplayContext transformType;
    protected FlamesOfEldritchLevelThreeItem animatable;
    private final Set<String> hiddenBones = new HashSet<String>();
    private final Set<String> suppressedBones = new HashSet<String>();

    public FlamesOfEldritchLevelThreeRenderer() {
        super((GeoModel)new FlamesOfEldritchLevelThreeModel());
        this.addRenderLayer(new FlamesOfEldritchLevelThreeLayer((GeoRenderer<FlamesOfEldritchLevelThreeItem>)this));
    }

    public RenderType getRenderType(FlamesOfEldritchLevelThreeItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    public ResourceLocation getTextureLocation(FlamesOfEldritchLevelThreeItem instance) {
