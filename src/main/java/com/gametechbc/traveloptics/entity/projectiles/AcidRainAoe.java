...
implements AntiMagicSusceptible {
    ...
    public AcidRainAoe(Level level) {
        this((EntityType<? extends Projectile>)((EntityType)TravelopticsEntities.ACID_RAIN_ENTITY.get()), level);
    }
    ...
    public void m_8119_() {
        ...
        if (!this.m_9236_().f_46443_ && this.tickCounter == 1) {
            this.m_5496_((SoundEvent)TravelopticsSounds.ACID_RAIN_ACTIVE.get(), 1.5f, 1.0f);
        }
        ...
        if (!this.m_9236_().f_46443_ && this.f_19797_ >= 140) {
            this.m_146870_();
        }
    }
    ...
    private void applyCorrodedEffectToEntities() {
        this.m_9236_().m_6249_((Entity)this, this.m_20191_(), entity -> entity instanceof LivingEntity).forEach(entity -> {
            ...
            target.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.CORRODED.get(), 100, this.getCorrodedEffectAmplifier(), false, false, true));
        });
    }
    ...
    private void increaseFireTicksForEntities() {
        this.m_9236_().m_6249_((Entity)this, this.m_20191_(), entity -> entity instanceof LivingEntity).forEach(entity -> {
            if (entity.m_6060_()) {
                entity.m_20254_(entity.m_20094_() / 20 + 1);
            }
        });
    }
    ...
    private void cleanseBeneficialEffects(LivingEntity entity) {
        List<MobEffect> beneficialEffects = entity.m_21220_().stream().map(MobEffectInstance::m_19544_).filter(effect -> effect.m_19483_() == MobEffectCategory.BENEFICIAL).filter(effect -> !this.isEffectBlacklisted((MobEffect)effect)).toList();
        beneficialEffects.forEach(arg_0 -> ((LivingEntity)entity).m_21195_(arg_0));
    }

    private boolean isEffectBlacklisted(MobEffect effect) {
        ResourceLocation effectLocation = BuiltInRegistries.f_256974_.m_7981_((Object)effect);
        List blacklist = (List)CommonConfig.acidRainImmuneEffects.get();
        return effectLocation != null && blacklist.contains(effectLocation.toString());
    }
    ...
    private void spawnAcidParticles() {
        ...
        for (int i = 0; i < particleCount; ++i) {
            ...
            this.m_9236_().m_7106_(TravelopticsParticleHelper.ACID_DROP, randomX, randomY, randomZ, 0.0, velocityY, 0.0);
        }
    }
    ...
    private void spawnCloudParticles() {
        ...
        for (int i = 0; i < particleCount; ++i) {
            ...
            double randomZ = this.m_20189_() + (this.f_19796_.m_188500_() * 2.0 * radius - radius);
            double velocityY = -0.5 - this.f_19796_.m_188500_() * 0.5;
            this.m_9236_().m_7106_(ParticleHelper.POISON_CLOUD, randomX, randomY, randomZ, 0.0, velocityY, 0.0);
        }
    }
    ...
    protected void m_7380_(CompoundTag compound) {
        ...
        compound.m_128405_("CorrodedEffectAmplifier", this.corrodedEffectAmplifier);
    }

    protected void m_7378_(CompoundTag compound) {
        super.m_7378_(compound);
        if (compound.m_128425_("CorrodedEffectAmplifier", 3)) {
            this.corrodedEffectAmplifier = compound.m_128451_("CorrodedEffectAmplifier");
        }
    }
}
