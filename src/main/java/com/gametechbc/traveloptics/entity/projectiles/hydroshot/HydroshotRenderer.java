...
public class HydroshotRenderer
extends EntityRenderer<Projectile> {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("traveloptics", "hydroshot_model"), "main");
    private static ResourceLocation TEXTURE = TravelopticsMod.id("textures/entity/hydroshot/hydroshot.png");
    private final ModelPart body;

    public HydroshotRenderer(EntityRendererProvider.Context context) {
        super(context);
