...
public class BlueCoralBoltProjectile
...
implements IEntityAdditionalSpawnData {
    ...
    public BlueCoralBoltProjectile(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.m_20242_(true);
    }

    public BlueCoralBoltProjectile(Level pLevel, LivingEntity pShooter) {
        this((EntityType<? extends Projectile>)((EntityType)TravelopticsEntities.BLUE_CORAL_BOLT_PROJECTILE.get()), pLevel);
    ...
    protected void m_5790_(EntityHitResult pResult) {
        if (!this.m_9236_().f_46443_) {
            ...
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)new BlastwaveParticleOptions(new Vector3f(0.2471f, 0.4235f, 0.898f), 2.0f), (double)this.m_20185_(), (double)(this.m_20186_() + (double)0.165f), (double)this.m_20189_(), (int)1, (double)0.0, (double)0.0, (double)0.0, (double)0.0, (boolean)true);
        }
    }
    ...
    public void trailParticles() {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            this.m_9236_().m_7106_(TravelopticsParticleHelper.BLUE_CORAL_BUBBLE, x - random.f_82479_, y + 0.5 - random.f_82480_, z - random.f_82481_, random.f_82479_ * 0.5, random.f_82480_ * 0.5, random.f_82481_ * 0.5);
        }
    }

    public void impactParticles(double x, double y, double z) {
        MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)TravelopticsParticleHelper.BLUE_CORAL_SPARKS, (double)x, (double)y, (double)z, (int)15, (double)0.1, (double)0.1, (double)0.1, (double)0.25, (boolean)true);
    }
