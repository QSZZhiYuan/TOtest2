...
public class PinkCoralBoltRenderer
extends EntityRenderer<Projectile> {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("traveloptics", "pink_coral_bolt_model"), "main");
    private static ResourceLocation TEXTURE = TravelopticsMod.id("textures/entity/coral_bolt/pink_coral_bolt.png");
    private final ModelPart body;

    public PinkCoralBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
