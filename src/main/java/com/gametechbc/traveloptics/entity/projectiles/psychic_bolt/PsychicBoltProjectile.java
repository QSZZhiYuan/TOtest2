 ...
 *  org.joml.Vector3f
 */
package com.gametechbc.traveloptics.entity.projectiles.psychic_bolt;
...
implements IEntityAdditionalSpawnData {
    ...
    public PsychicBoltProjectile(Level pLevel, LivingEntity pShooter) {
        this((EntityType<? extends Projectile>)((EntityType)TravelopticsEntities.PSYCHIC_BOLT_PROJECTILE.get()), pLevel);
    ...
    protected void m_5790_(EntityHitResult pResult) {
        if (!this.m_9236_().f_46443_) {
            ...
            if (target instanceof LivingEntity) {
                ...
                livingTarget.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.PSYCHIC_CONTROL.get(), this.getEffectDuration(), 0, false, false, false));
            }
            ...
            for (Entity entity2 : nearbyEntities) {
                ...
                livingEntity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.PSYCHIC_CONTROL.get(), this.getEffectDuration(), 0, false, false, false));
            }
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)new BlastwaveParticleOptions(new Vector3f(0.1608f, 0.8745f, 0.9216f), 2.0f), (double)this.m_20185_(), (double)(this.m_20186_() + (double)0.165f), (double)this.m_20189_(), (int)1, (double)0.0, (double)0.0, (double)0.0, (double)0.0, (boolean)true);
        }
    }
    ...
    public void trailParticles() {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            this.m_9236_().m_7106_((ParticleOptions)ParticleTypes.f_235898_, x - random.f_82479_, y + 0.5 - random.f_82480_, z - random.f_82481_, random.f_82479_ * 0.5, random.f_82480_ * 0.5, random.f_82481_ * 0.5);
        }
    }

    public void impactParticles(double x, double y, double z) {
        MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)TravelopticsParticleHelper.PSYCHIC_SPARKS, (double)x, (double)y, (double)z, (int)15, (double)0.1, (double)0.1, (double)0.1, (double)0.25, (boolean)false);
    }
    ...
    protected void m_7378_(CompoundTag tag) {
        ...
        if (tag.m_128441_("EffectDuration")) {
            this.effectDuration = tag.m_128451_("EffectDuration");
        }
    }
