...
extends AbstractConeProjectile {
    ...
    public void spawnParticles() {
        ...
        for (int i = 0; i < 20; ++i) {
            ...
            this.m_9236_().m_7106_((ParticleOptions)(this.f_19796_.m_188501_() < 0.7f ? TravelopticsParticleHelper.WATER_BUBBLE : ParticleTypes.f_123796_), x + ox, y + oy, z + oz, result.f_82479_, result.f_82480_, result.f_82481_);
        }
    }

    protected void m_5790_(EntityHitResult entityHitResult) {
        Entity entity = entityHitResult.m_82443_();
        if (DamageSources.applyDamage((Entity)entity, (float)this.damage, (DamageSource)((AbstractSpell)TravelopticsSpells.BUBBLE_SPRAY_SPELL.get()).getDamageSource((Entity)this, this.m_19749_())) && entity instanceof LivingEntity) {
            LivingEntity livingEntity = (LivingEntity)entity;
            livingEntity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.WET.get(), 60, 3));
        }
    }
}
