...
public class BlueCoralBoltRenderer
extends EntityRenderer<Projectile> {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("traveloptics", "blue_coral_bolt_model"), "main");
    private static ResourceLocation TEXTURE = TravelopticsMod.id("textures/entity/coral_bolt/blue_coral_bolt.png");
    private final ModelPart body;

    public BlueCoralBoltRenderer(EntityRendererProvider.Context context) {
        super(context);
