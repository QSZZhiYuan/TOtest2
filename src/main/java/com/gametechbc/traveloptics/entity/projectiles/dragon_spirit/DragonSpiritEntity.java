...
TraceableEntity {
    ...
    private void updateRotation() {
        ...
        if (motion.m_82556_() > 0.0) {
            ...
            this.m_146926_(DragonSpiritEntity.lerpRotation(this.f_19860_, (float)(Mth.m_14136_((double)motion.f_82480_, (double)horizontalDistance) * 57.29577951308232)));
            this.m_146922_(DragonSpiritEntity.lerpRotation(this.f_19859_, (float)(Mth.m_14136_((double)motion.f_82479_, (double)motion.f_82481_) * 57.29577951308232)));
        }
    }
