...
extends DeadKingBoss {
    ...
    protected void setFinalPhaseGoals() {
        this.f_21345_.m_25386_().forEach(WrappedGoal::m_8041_);
        this.f_21345_.m_262460_(x -> true);
        this.f_21345_.m_25352_(1, (Goal)new DeadKingBarrageGoal((IMagicEntity)this, (AbstractSpell)TravelopticsSpells.BLOOD_HOWL_SPELL.get(), 3, 3, 60, 140, 4));
        this.f_21345_.m_25352_(2, (Goal)new DeadKingBarrageGoal((IMagicEntity)this, (AbstractSpell)TravelopticsSpells.NOCTURNAL_SWARM_SPELL.get(), 4, 6, 400, 600, 1));
        this.f_21345_.m_25352_(3, (Goal)new DeadKingBarrageGoal((IMagicEntity)this, (AbstractSpell)TravelopticsSpells.METEOR_STORM.get(), 4, 4, 600, 800, 1));
    ...
    public static AttributeSupplier.Builder deadkingAttributes() {
        return LivingEntity.m_21183_().m_22268_(Attributes.f_22281_, 14.0).m_22268_((Attribute)AttributeRegistry.SPELL_POWER.get(), 1.5).m_22268_(Attributes.f_22284_, 20.0).m_22268_((Attribute)AttributeRegistry.SPELL_RESIST.get(), 1.25).m_22268_(Attributes.f_22276_, 600.0).m_22268_(Attributes.f_22278_, 1.0).m_22268_(Attributes.f_22282_, 0.6).m_22268_(Attributes.f_22277_, 64.0).m_22268_(Attributes.f_22279_, 0.155);
    }
    ...
    extends SpellBarrageGoal {
        ...
        public boolean m_8036_() {
            return !EnragedDeadKingBoss.this.isMeleeing && super.m_8036_();
        }
    }
}
