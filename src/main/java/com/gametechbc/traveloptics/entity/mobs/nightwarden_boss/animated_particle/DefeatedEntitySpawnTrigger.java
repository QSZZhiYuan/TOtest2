        ...
        block17: {
            ...
            block19: {
                ...
                block18: {
                    block16: {
                        ...
                        random = boss.m_217043_();
                        centerX = boss.m_20185_();
                        centerY = boss.m_20186_();
                        centerZ = boss.m_20189_();
                        ...
                        for (int arm = 0; arm < spiralArms; ++arm) {
                            ...
                            for (int p = 0; p < 14; ++p) {
                                ...
                                boss.m_9236_().m_7106_(TravelopticsParticleHelper.SHORT_LIGHT_PURPLE_GLOWING_ENCHANT, x2, y, z2, 0.0, 0.01, 0.0);
                                if (random.m_188501_() < 0.25f) {
                                    boss.m_9236_().m_7106_(TravelopticsParticleHelper.ABYSS_SPIKE_PARTICLE, x2, y + 0.4, z2, -Math.cos(angle2) * 0.025, -0.045, -Math.sin(angle2) * 0.025);
                                }
                                if (!(random.m_188501_() < 0.1f)) continue;
                                boss.m_9236_().m_7106_(TravelopticsParticleHelper.SHORT_LIGHT_RED_GLOWING_ENCHANT, x2, y + 0.3, z2, 0.0, 0.08, 0.0);
                            }
                        }
                        break block17;
                    }
                    ...
                    for (int wave = 0; wave < 5; ++wave) {
                        ...
                        for (int i2 = 0; i2 < 10; ++i2) {
                            ...
                            boss.m_9236_().m_7106_(random.m_188501_() < 0.6f ? TravelopticsParticleHelper.SHORT_LIGHT_RED_GLOWING_ENCHANT : TravelopticsParticleHelper.ABYSS_SPIKE_PARTICLE, x3, y, z3, 0.0, 0.015, 0.0);
                            if (!(random.m_188501_() < 0.15f)) continue;
                            boss.m_9236_().m_7106_(TravelopticsParticleHelper.SHORT_LIGHT_PURPLE_GLOWING_ENCHANT, x3, y + 0.3, z3, (random.m_188500_() - 0.5) * 0.2, 0.1, (random.m_188500_() - 0.5) * 0.2);
                        }
                    }
                    if (!(random.m_188501_() < 0.3f)) break block17;
                    boss.m_9236_().m_7106_(TravelopticsParticleHelper.ABYSS_SPIKE_PARTICLE, centerX, centerY + 0.3, centerZ, 0.0, 0.035, 0.0);
                    break block17;
                }
                ...
                for (int i3 = 0; i3 < 22; ++i3) {
                    ...
                    ParticleOptions flare = random.m_188501_() < 0.4f ? TravelopticsParticleHelper.SHORT_LIGHT_RED_GLOWING_ENCHANT : TravelopticsParticleHelper.SHORT_LIGHT_PURPLE_GLOWING_ENCHANT;
                    boss.m_9236_().m_7106_(flare, x4, y, z4, 0.0, 0.01, 0.0);
                }
                if ((int)currentAnimTime % 5 != 0) break block17;
                float orbitY = (float)(centerY + (double)1.4f + (double)(Mth.m_14031_((float)(currentAnimTime * 0.05f)) * 0.3f));
                for (int i4 = 0; i4 < 20; ++i4) {
                    angle = (float)i4 * ((float)Math.PI * 2) / 20.0f;
                    double x5 = centerX + Math.cos(angle) * 1.7;
                    double z5 = centerZ + Math.sin(angle) * 1.7;
                    boss.m_9236_().m_7106_(TravelopticsParticleHelper.SHORT_LIGHT_PURPLE_GLOWING_ENCHANT, x5, (double)orbitY, z5, 0.0, 0.01, 0.0);
                    if (!(random.m_188501_() < 0.1f)) continue;
                    boss.m_9236_().m_7106_(TravelopticsParticleHelper.ABYSS_SPIKE_PARTICLE, x5, (double)orbitY + 0.3, z5, 0.0, 0.07, 0.0);
                }
                break block17;
            }
            ...
            if (t < 0.5f) {
                ...
                for (int i5 = 0; i5 < 28; ++i5) {
                    ...
                    boss.m_9236_().m_7106_(random.m_188501_() < 0.5f ? TravelopticsParticleHelper.ABYSS_SPIKE_PARTICLE : TravelopticsParticleHelper.SHORT_LIGHT_RED_GLOWING_ENCHANT, x, centerY + 0.2, z, 0.0, 0.09, 0.0);
                }
            }
            for (i = 0; i < 36; ++i) {
                float angle = random.m_188501_() * ((float)Math.PI * 2);
                float dist = random.m_188501_() * 1.6f;
                x = centerX + Math.cos(angle) * (double)dist;
                z = centerZ + Math.sin(angle) * (double)dist;
                double y = centerY + (double)(random.m_188501_() * 2.8f);
                ParticleOptions particle = switch (random.m_188503_(3)) {
                ...
                boss.m_9236_().m_7106_(particle, x, y, z, 0.0, 0.13 + (double)random.m_188501_() * 0.15, 0.0);
            }
            if (t > 0.85f) {
                for (i = 0; i < 16; ++i) {
                    double x6 = centerX + (random.m_188500_() - 0.5) * 2.4;
                    double y = centerY + 1.0 + random.m_188500_() * 1.8;
                    z = centerZ + (random.m_188500_() - 0.5) * 2.4;
                    boss.m_9236_().m_7106_(TravelopticsParticleHelper.SHORT_LIGHT_PURPLE_GLOWING_ENCHANT, x6, y, z, 0.0, 0.03, 0.0);
                }
            }
        }
    }
