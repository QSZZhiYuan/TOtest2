...
public class SummonedIgnitedBerserker
extends Ignited_Berserker_Entity
implements MagicFireSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedIgnitedBerserker(EntityType<? extends Ignited_Berserker_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedIgnitedBerserker(Level level, LivingEntity owner) {
        this((EntityType<? extends Ignited_Berserker_Entity>)((EntityType)TravelopticsEntities.SUMMONED_IGNITED_BERSERKER.get()), level);
