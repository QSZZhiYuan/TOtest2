...
import com.gametechbc.traveloptics.api.entity.mobs.MagicFireSummon;
...
public class SummonedIgnitedRevenant
extends Ignited_Revenant_Entity
implements MagicFireSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedIgnitedRevenant(EntityType<? extends Ignited_Revenant_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedIgnitedRevenant(Level level, LivingEntity owner) {
        this((EntityType<? extends Ignited_Revenant_Entity>)((EntityType)TravelopticsEntities.SUMMONED_IGNITED_REVENANT.get()), level);
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper((Entity)this, (SummonTimer)TravelopticsEffects.IGNITED_ONSLAUGHT_TIMER.get());
    ...
    public boolean m_7327_(Entity pEntity) {
        return Utils.doMeleeAttack((Mob)this, (Entity)pEntity, (DamageSource)((AbstractSpell)TravelopticsSpells.IGNITED_ONSLAUGHT_SPELL.get()).getDamageSource((Entity)this, (Entity)this.getSummoner()));
    }
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)ParticleHelper.FIRE, (double)this.m_20185_(), (double)(this.m_20186_() + 2.5), (double)this.m_20189_(), (int)20, (double)0.0, (double)0.0, (double)0.0, (double)0.3, (boolean)false);
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)ParticleTypes.f_123762_, (double)this.m_20185_(), (double)(this.m_20186_() + 2.5), (double)this.m_20189_(), (int)45, (double)0.0, (double)0.0, (double)0.0, (double)0.3, (boolean)false);
            this.m_146870_();
        }
    }
    ...
    public boolean m_7301_(MobEffectInstance effectInstance) {
        if (effectInstance.m_19544_() == TravelopticsEffects.IGNITED_ONSLAUGHT_TIMER.get()) {
            return true;
        }
