...
public class SummonedEnderGolem
extends Ender_Golem_Entity
implements MagicSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedEnderGolem(EntityType<? extends Ender_Golem_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedEnderGolem(Level level, LivingEntity owner) {
        this((EntityType<? extends Ender_Golem_Entity>)((EntityType)TravelopticsEntities.SUMMONED_ENDER_GOLEM.get()), level);
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper((Entity)this, (SummonTimer)TravelopticsEffects.ENDER_GOLEM_TIMER.get());
    ...
    public boolean m_7327_(Entity pEntity) {
        return Utils.doMeleeAttack((Mob)this, (Entity)pEntity, (DamageSource)((AbstractSpell)TravelopticsSpells.ETERNAL_SENTINEL_SPELL.get()).getDamageSource((Entity)this, (Entity)this.getSummoner()));
    }
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)ParticleTypes.f_123789_, (double)this.m_20185_(), (double)(this.m_20186_() + 1.5), (double)this.m_20189_(), (int)50, (double)0.0, (double)0.0, (double)0.0, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
    ...
    public boolean m_7301_(MobEffectInstance effectInstance) {
        if (effectInstance.m_19544_() == TravelopticsEffects.ENDER_GOLEM_TIMER.get()) {
            return true;
        }
