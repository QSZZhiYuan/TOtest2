...
public class SummonedWadjet
extends Wadjet_Entity
implements MagicFossilSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedWadjet(EntityType<? extends Wadjet_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedWadjet(Level level, LivingEntity owner) {
        this((EntityType<? extends Wadjet_Entity>)((EntityType)TravelopticsEntities.SUMMONED_WADJET.get()), level);
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)((ParticleOptions)ModParticle.SANDSTORM.get()), (double)this.m_20185_(), (double)(this.m_20186_() + 1.0), (double)this.m_20189_(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
    ...
    public boolean m_7301_(MobEffectInstance effectInstance) {
        if (effectInstance.m_19544_() == TravelopticsEffects.DESERT_DWELLER_TIMER.get()) {
            return true;
        }
