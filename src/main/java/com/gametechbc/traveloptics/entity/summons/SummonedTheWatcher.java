...
implements MagicElectricSummon {
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)ParticleTypes.f_123759_, (double)this.m_20185_(), (double)(this.m_20186_() + 0.2), (double)this.m_20189_(), (int)15, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
