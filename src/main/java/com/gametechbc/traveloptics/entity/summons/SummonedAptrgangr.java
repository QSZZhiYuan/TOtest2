...
public class SummonedAptrgangr
extends Aptrgangr_Entity
implements MagicCursedSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedAptrgangr(EntityType<? extends Aptrgangr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedAptrgangr(Level level, LivingEntity owner) {
        this((EntityType<? extends Aptrgangr_Entity>)((EntityType)TravelopticsEntities.SUMMONED_APTRGANGR.get()), level);
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper((Entity)this, (SummonTimer)TravelopticsEffects.APTRGANGR_TIMER.get());
    ...
    public boolean m_7327_(Entity pEntity) {
        return Utils.doMeleeAttack((Mob)this, (Entity)pEntity, (DamageSource)((AbstractSpell)TravelopticsSpells.AXE_OF_THE_DOOMED_SPELL.get()).getDamageSource((Entity)this, (Entity)this.getSummoner()));
    }
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)((ParticleOptions)ModParticle.CURSED_FLAME.get()), (double)this.m_20185_(), (double)(this.m_20186_() + 1.8), (double)this.m_20189_(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
