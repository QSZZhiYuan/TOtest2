...
public class SummonedDeepling
extends Deepling_Entity
implements MagicSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedDeepling(EntityType<SummonedDeepling> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedDeepling(Level level, LivingEntity owner) {
        this((EntityType<SummonedDeepling>)((EntityType)TravelopticsEntities.SUMMONED_DEEPLING.get()), level);
    ...
    public boolean m_7327_(Entity pEntity) {
        return Utils.doMeleeAttack((Mob)this, (Entity)pEntity, (DamageSource)((AbstractSpell)SpellRegistry.SUMMON_POLAR_BEAR_SPELL.get()).getDamageSource((Entity)this, (Entity)this.getSummoner()));
    }
