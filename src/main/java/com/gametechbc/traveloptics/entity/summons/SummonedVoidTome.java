...
implements MagicSummon {
    ...
    public void m_8099_() {
        ...
        this.f_21345_.m_25352_(3, (Goal)new GenericFollowOwnerGoal((PathfinderMob)this, this::getSummoner, 1.0, 9.0f, 4.0f, true, 20.0f));
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)TravelopticsParticleHelper.LIGHT_RED_GLOWING_ENCHANT, (double)this.m_20185_(), (double)(this.m_20186_() + 1.8), (double)this.m_20189_(), (int)30, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
