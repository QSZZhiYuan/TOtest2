...
implements MagicCursedSummon {
    ...
    public SummonedDraugr(Level level, LivingEntity owner) {
        this((EntityType<? extends Draugr_Entity>)((EntityType)TravelopticsEntities.SUMMONED_DRAUGR.get()), level);
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)((ParticleOptions)ModParticle.CURSED_FLAME.get()), (double)this.m_20185_(), (double)(this.m_20186_() + 0.5), (double)this.m_20189_(), (int)20, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
