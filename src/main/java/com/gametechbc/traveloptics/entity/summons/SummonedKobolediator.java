...
public class SummonedKobolediator
extends Kobolediator_Entity
implements MagicFossilSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedKobolediator(EntityType<? extends Kobolediator_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedKobolediator(Level level, LivingEntity owner) {
        this((EntityType<? extends Kobolediator_Entity>)((EntityType)TravelopticsEntities.SUMMONED_KOBOLEDIATOR.get()), level);
    ...
    public void m_8099_() {
        ...
        this.f_21346_.m_25352_(4, (Goal)new GenericHurtByTargetGoal((PathfinderMob)this, this::isValidTarget).setAlertOthers(new Class[0]));
    ...
    private boolean isValidTarget(Entity entity) {
        ...
        return server != null && server.m_129799_();
    }
    ...
    public void onRemovedFromWorld() {
        this.onRemovedHelper((Entity)this, (SummonTimer)TravelopticsEffects.KOBOLEDIATOR_TIMER.get());
    ...
    public boolean m_7327_(Entity pEntity) {
        return Utils.doMeleeAttack((Mob)this, (Entity)pEntity, (DamageSource)((AbstractSpell)TravelopticsSpells.SWORD_OF_THE_ANCIENTS_SPELL.get()).getDamageSource((Entity)this, (Entity)this.getSummoner()));
    }
    ...
    public void onUnSummon() {
        if (!this.m_9236_().f_46443_) {
            MagicManager.spawnParticles((Level)this.m_9236_(), (ParticleOptions)((ParticleOptions)ModParticle.SANDSTORM.get()), (double)this.m_20185_(), (double)(this.m_20186_() + 1.5), (double)this.m_20189_(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.m_146870_();
        }
    }
    ...
    public boolean m_7301_(MobEffectInstance effectInstance) {
        if (effectInstance.m_19544_() == TravelopticsEffects.KOBOLEDIATOR_TIMER.get()) {
            return true;
        }
