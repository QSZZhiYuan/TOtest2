...
public class SummonedRoyalDraugr
extends Royal_Draugr_Entity
implements MagicCursedSummon {
    protected LivingEntity cachedSummoner;
    protected UUID summonerUUID;

    public SummonedRoyalDraugr(EntityType<? extends Royal_Draugr_Entity> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.f_21364_ = 0;
    }

    public SummonedRoyalDraugr(Level level, LivingEntity owner) {
        this((EntityType<? extends Royal_Draugr_Entity>)((EntityType)TravelopticsEntities.SUMMONED_ROYAL_DRAUGR.get()), level);
