...
import com.gametechbc.traveloptics.entity.armor.cursed_wraithguard_armor.CursedWraithguardArmorLayer;
...
public class CursedWraithguardArmorRenderer
extends GeoArmorRenderer<CursedWraithguardArmorItem> {
    public CursedWraithguardArmorRenderer(CursedWraithguardArmorModel abyssalHideArmorModel) {
        super((GeoModel)new CursedWraithguardArmorModel());
        this.addRenderLayer(new CursedWraithguardArmorLayer((GeoRenderer<CursedWraithguardArmorItem>)this));
    ...
    public RenderType getRenderType(CursedWraithguardArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
