...
import com.gametechbc.traveloptics.entity.armor.primordial_crest_armor.PrimordialCrestArmorLayer;
...
public class PrimordialCrestArmorArmorRenderer
extends GeoArmorRenderer<PrimordialCrestArmorItem> {
    public PrimordialCrestArmorArmorRenderer(PrimordialCrestArmorModel primordialCrestArmorModel) {
        super((GeoModel)new PrimordialCrestArmorModel());
        this.addRenderLayer(new PrimordialCrestArmorLayer(this));
    ...
    public RenderType getRenderType(PrimordialCrestArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
