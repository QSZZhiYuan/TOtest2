...
import com.gametechbc.traveloptics.entity.armor.deepling_mage_armor.DeeplingMageArmorLayer;
...
public class DeeplingMageArmorRenderer
extends GeoArmorRenderer<DeeplingMageArmorItem> {
    public DeeplingMageArmorRenderer(DeeplingMageArmorModel deeplingMageArmorModel) {
        super((GeoModel)new DeeplingMageArmorModel());
        this.addRenderLayer(new DeeplingMageArmorLayer((GeoRenderer<DeeplingMageArmorItem>)this));
    ...
    public RenderType getRenderType(DeeplingMageArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
