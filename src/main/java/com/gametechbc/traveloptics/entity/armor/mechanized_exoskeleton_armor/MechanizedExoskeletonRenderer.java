...
import com.gametechbc.traveloptics.entity.armor.mechanized_exoskeleton_armor.MechanizedExoskeletonLayer;
...
public class MechanizedExoskeletonRenderer
extends GeoArmorRenderer<MechanizedExoskeletonArmorItem> {
    public MechanizedExoskeletonRenderer(MechanizedExoskeletonModel mechanizedExoskeletonModel) {
        super((GeoModel)new MechanizedExoskeletonModel());
        this.addRenderLayer(new MechanizedExoskeletonLayer((GeoRenderer<MechanizedExoskeletonArmorItem>)this));
    ...
    public RenderType getRenderType(MechanizedExoskeletonArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
