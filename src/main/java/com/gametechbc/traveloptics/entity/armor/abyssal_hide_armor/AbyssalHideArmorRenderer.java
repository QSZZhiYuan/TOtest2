...
import com.gametechbc.traveloptics.entity.armor.abyssal_hide_armor.AbyssalHideArmorLayer;
...
public class AbyssalHideArmorRenderer
extends GeoArmorRenderer<AbyssalHideArmorItem> {
    public AbyssalHideArmorRenderer(AbyssalHideArmorModel abyssalHideArmorModel) {
        super((GeoModel)new AbyssalHideArmorModel());
        this.addRenderLayer(new AbyssalHideArmorLayer((GeoRenderer<AbyssalHideArmorItem>)this));
    ...
    public RenderType getRenderType(AbyssalHideArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
