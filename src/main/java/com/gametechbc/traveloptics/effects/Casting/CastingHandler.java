...
public class CastingHandler {
    ...
    public static void onPlayerCast(SpellPreCastEvent event) {
        ...
        if (entity instanceof ServerPlayer) {
            ...
            if (!player.m_9236_().f_46443_ && (blackoutEffect = player.m_21124_((MobEffect)TravelopticsEffects.CASTING.get())) != null) {
                event.setCanceled(true);
                player.m_5661_((Component)Component.m_237115_((String)"effect.traveloptics.casting.warning").m_130940_(ChatFormatting.RED), true);
            }
        }
    }
    ...
    public static void onEntityCast(LivingEvent.LivingTickEvent event) {
        ...
        boolean blackoutEffect = entity.m_21023_((MobEffect)TravelopticsEffects.CASTING.get());
