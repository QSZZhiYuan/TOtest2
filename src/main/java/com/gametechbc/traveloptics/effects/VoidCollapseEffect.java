        ...
        if (effectInstance != null) {
            ...
            if (duration > 20) {
                ...
                if (duration == 5) {
                    ...
                    entity.m_6469_(entity.m_269291_().m_269425_(), damageAmount);
                }
            }
            if (!entity.m_9236_().f_46443_ && entity.f_19797_ % 2 == 0) {
                for (int i = 0; i < 5; ++i) {
                    ...
                    ((ServerLevel)entity.m_9236_()).m_8767_((ParticleOptions)((SimpleParticleType)TravelopticsParticles.PURPLE_STAR_OUTWARD_PARTICLE.get()), entity.m_20185_() + offsetX, entity.m_20186_() + offsetY, entity.m_20189_() + offsetZ, 1, 0.0, 0.0, 0.0, 0.0);
                }
            }
        }
    }
