...
public class BlackoutHandler {
    ...
    public static void onPlayerCast(SpellPreCastEvent event) {
        ...
        if (entity instanceof ServerPlayer) {
            ...
            if (!player.m_9236_().f_46443_ && (blackoutEffect = player.m_21124_((MobEffect)TravelopticsEffects.BLACKOUT.get())) != null) {
                event.setCanceled(true);
                player.m_5661_((Component)Component.m_237113_((String)"Blackout Active: Spells are suppressed!").m_130940_(ChatFormatting.RED), true);
    ...
    public static void onEntityCast(LivingEvent.LivingTickEvent event) {
        ...
        boolean blackoutEffect = entity.m_21023_((MobEffect)TravelopticsEffects.BLACKOUT.get());
        if (entity instanceof AbstractSpellCastingMob) {
            AbstractSpellCastingMob caster = (AbstractSpellCastingMob)entity;
            if (!caster.m_9236_().f_46443_ && blackoutEffect) {
                caster.cancelCast();
            }
        }
    }
    ...
    public static void onPlayerRightClickItem(PlayerInteractEvent.RightClickItem event) {
        ...
        if (entity instanceof ServerPlayer) {
            ...
            if (!player.m_9236_().f_46443_ && (blackoutEffect = player.m_21124_((MobEffect)TravelopticsEffects.BLACKOUT.get())) != null) {
                event.setCanceled(true);
                player.m_5661_((Component)Component.m_237113_((String)"Blackout Active: Cannot use items!").m_130940_(ChatFormatting.RED), true);
                player.m_9236_().m_6263_(null, player.m_20185_(), player.m_20186_(), player.m_20189_(), SoundEvents.f_11683_, SoundSource.PLAYERS, 0.5f, 1.0f);
            }
        }
    }
    ...
    public static void onManaRegen(ChangeManaEvent event) {
        if (event.getEntity().m_21023_((MobEffect)TravelopticsEffects.BLACKOUT.get())) {
            event.setCanceled(true);
        }
    }
}
