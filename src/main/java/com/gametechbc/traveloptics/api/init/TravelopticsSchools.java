...
public class TravelopticsSchools {
    ...
    public static final RegistryObject<SchoolType> AQUA = TravelopticsSchools.registerSchool(new SchoolType(AQUA_RESOURCE, TravelopticsTags.AQUA_FOCUS, (Component)Component.m_237115_((String)"school.traveloptics.aqua").m_130938_(style -> style.m_178520_(5745885)), LazyOptional.of(() -> TravelopticsAttributes.AQUA_SPELL_POWER.get()), LazyOptional.of(() -> TravelopticsAttributes.AQUA_MAGIC_RESIST.get()), TravelopticsDamageTypes.AQUA_MAGIC));

    public static RegistryObject<SchoolType> registerSchool(SchoolType schoolType) {
        return TRAVELOPTICS_SCHOOLS.register(schoolType.getId().m_135815_(), () -> schoolType);
    }
}
