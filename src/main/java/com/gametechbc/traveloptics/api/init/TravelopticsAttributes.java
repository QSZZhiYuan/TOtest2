...
public class TravelopticsAttributes {
    ...
    public static RegistryObject<Attribute> aquaResistanceAttribute(String id) {
        return ATTRIBUTES.register(id + "_magic_resist", () -> new MagicRangedAttribute("attribute.traveloptics." + id + "_magic_resist", 1.0, -100.0, 100.0).m_22084_(true));
    }

    public static RegistryObject<Attribute> aquaPowerAttribute(String id) {
        return ATTRIBUTES.register(id + "_spell_power", () -> new MagicRangedAttribute("attribute.traveloptics." + id + "_spell_power", 1.0, -100.0, 100.0).m_22084_(true));
    }
