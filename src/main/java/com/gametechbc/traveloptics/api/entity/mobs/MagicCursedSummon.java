...
public interface MagicCursedSummon
extends MagicSummon {
        ...
        if (reason != null && (livingEntity = this.getSummoner()) instanceof ServerPlayer) {
            ...
            if (reason.m_146965_()) {
                ...
                if (reason.equals((Object)Entity.RemovalReason.DISCARDED)) {
                    player.m_213846_((Component)Component.m_237110_((String)"ui.traveloptics.cursed_summon_despawn_message", (Object[])new Object[]{((Entity)this).m_5446_()}));
                }
            }
        }
    }
