...
public class TravelopticsBlocks {
    ...
    public static final RegistryObject<Block> RUNED_PURPUR_BLOCK = BLOCKS.register("runed_purpur_block", () -> new Block(BlockBehaviour.Properties.m_60926_((BlockBehaviour)Blocks.f_50492_)));
}
