...
public class TravelopticsItems {
    ...
    public static final Rarity RARITY_ABYSSAL = Rarity.create((String)"traveloptics:abyssal", style -> style.m_178520_(10313471));
    public static final Rarity RARITY_ANCIENT = Rarity.create((String)"traveloptics:ancient", style -> style.m_178520_(16770714));
    public static final Rarity RARITY_CURSED = Rarity.create((String)"traveloptics:cursed", style -> style.m_178520_(5104836));
    public static final Rarity RARITY_MECHANIZED = Rarity.create((String)"traveloptics:mechanized", style -> style.m_178520_(11582917));
    public static final Rarity RARITY_NATURAL = Rarity.create((String)"traveloptics:natural", style -> style.m_178520_(7377453));
    public static final Rarity RARITY_IGNIS = Rarity.create((String)"traveloptics:ignis", style -> style.m_178520_(16766783));
    public static final Rarity RARITY_AMETHYST = Rarity.create((String)"traveloptics:amethyst", style -> style.m_178520_(13144304));
    public static final Rarity RARITY_VOID = Rarity.create((String)"traveloptics:void", style -> style.m_178520_(15238655));
    public static final Rarity RARITY_TOXIC = Rarity.create((String)"traveloptics:toxic", style -> style.m_178520_(7591680));
    public static final Rarity RARITY_TECTONIC = Rarity.create((String)"traveloptics:tectonic", style -> style.m_178520_(16738048));
    public static final Rarity RARITY_RETRO = Rarity.create((String)"traveloptics:retro", style -> style.m_178520_(13348095));
    public static final Rarity RARITY_PRIMORDIAL = Rarity.create((String)"traveloptics:primordial", style -> style.m_178520_(11709848));
    public static final Rarity RARITY_ELDRITCH = Rarity.create((String)"traveloptics:eldritch", style -> style.m_178520_(37525));
    public static final Rarity RARITY_MONSTROUS = Rarity.create((String)"traveloptics:monstrous", style -> style.m_178520_(16293444));
    public static final Rarity RARITY_AQUATIC = Rarity.create((String)"traveloptics:aquatic", style -> style.m_178520_(7520974));
    public static final Rarity RARITY_FROSTED = Rarity.create((String)"traveloptics:frosted", style -> style.m_178520_(12642814));
    ...
    public static final RegistryObject<Item> ELDRITCH_UPGRADE_ORB = ITEMS.register("eldritch_upgrade_orb", () -> new UpgradeOrbItem((UpgradeType)TravelopticsUpgradeTypes.ELDRITCH_SPELL_POWER, ItemPropertiesHelper.material().m_41497_(RARITY_ELDRITCH)));
    public static final RegistryObject<Item> AQUA_UPGRADE_ORB = ITEMS.register("aqua_upgrade_orb", () -> new UpgradeOrbItem((UpgradeType)TravelopticsUpgradeTypes.AQUA_SPELL_POWER, ItemPropertiesHelper.material().m_41497_(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> EYE_OF_NOTHINGNESS = ITEMS.register("eye_of_nothingness", () -> new DungeonEyeItem(new Item.Properties().m_41486_(), TravelopticsTags.EYE_OF_NOTHINGNESS_DESTINATION, 60, 0, 132));
    ...
    public static final RegistryObject<Item> ETERNAL_MAELSTROM_TRIDENT = ITEMS.register("trident_of_the_eternal_maelstrom", () -> new TridentOfTheEternalMaelstromItem(new Item.Properties().m_41503_(((Integer)WeaponConfig.eternalMaelstromDurability.get()).intValue()).m_41497_(RARITY_AQUATIC).m_41486_()));
    public static final RegistryObject<Item> ETERNAL_MAELSTROM_TRIDENT_LEVEL_ONE = ITEMS.register("trident_of_the_eternal_maelstrom_level_one", () -> new TridentOfTheEternalMaelstromLevelOneItem(new Item.Properties().m_41503_(((Integer)WeaponConfig.eternalMaelstromDurability.get()).intValue()).m_41497_(RARITY_AQUATIC).m_41486_()));
    public static final RegistryObject<Item> ETERNAL_MAELSTROM_TRIDENT_LEVEL_TWO = ITEMS.register("trident_of_the_eternal_maelstrom_level_two", () -> new TridentOfTheEternalMaelstromLevelTwoItem(new Item.Properties().m_41503_(((Integer)WeaponConfig.eternalMaelstromDurability.get()).intValue()).m_41497_(RARITY_AQUATIC).m_41486_()));
    public static final RegistryObject<Item> ETERNAL_MAELSTROM_TRIDENT_LEVEL_THREE = ITEMS.register("trident_of_the_eternal_maelstrom_level_three", () -> new TridentOfTheEternalMaelstromLevelThreeItem(new Item.Properties().m_41503_(((Integer)WeaponConfig.eternalMaelstromDurability.get()).intValue()).m_41497_(RARITY_AQUATIC).m_41486_()));
    ...
    public static final RegistryObject<AbyssalHideArmorItem> ABYSSAL_HIDE_ARMOR_HAT = ITEMS.register("abyssal_hide_armor_hat", () -> new AbyssalHideArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_ABYSSAL)));
    public static final RegistryObject<AbyssalHideArmorItem> ABYSSAL_HIDE_ARMOR_ROBE = ITEMS.register("abyssal_hide_armor_robe", () -> new AbyssalHideArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_ABYSSAL)));
    public static final RegistryObject<AbyssalHideArmorItem> ABYSSAL_HIDE_ARMOR_LEGGINGS = ITEMS.register("abyssal_hide_armor_leggings", () -> new AbyssalHideArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_ABYSSAL)));
    public static final RegistryObject<AbyssalHideArmorItem> ABYSSAL_HIDE_ARMOR_BOOTS = ITEMS.register("abyssal_hide_armor_boots", () -> new AbyssalHideArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_ABYSSAL)));
    public static final RegistryObject<PrimordialCrestArmorItem> PRIMORDIAL_CREST_ARMOR_HELMET = ITEMS.register("primordial_crest_armor_helmet", () -> new PrimordialCrestArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_PRIMORDIAL)));
    public static final RegistryObject<PrimordialCrestArmorItem> PRIMORDIAL_CREST_ARMOR_CHESTPLATE = ITEMS.register("primordial_crest_armor_chestplate", () -> new PrimordialCrestArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_PRIMORDIAL)));
    public static final RegistryObject<PrimordialCrestArmorItem> PRIMORDIAL_CREST_ARMOR_LEGGINGS = ITEMS.register("primordial_crest_armor_leggings", () -> new PrimordialCrestArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_PRIMORDIAL)));
    public static final RegistryObject<PrimordialCrestArmorItem> PRIMORDIAL_CREST_ARMOR_BOOTS = ITEMS.register("primordial_crest_armor_boots", () -> new PrimordialCrestArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_PRIMORDIAL)));
    public static final RegistryObject<TectonicCrestArmorItem> TECTONIC_CREST_ARMOR_HELMET = ITEMS.register("tectonic_crest_armor_helmet", () -> new TectonicCrestArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_TECTONIC)));
    public static final RegistryObject<TectonicCrestArmorItem> TECTONIC_CREST_ARMOR_CHESTPLATE = ITEMS.register("tectonic_crest_armor_chestplate", () -> new TectonicCrestArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_TECTONIC)));
    public static final RegistryObject<TectonicCrestArmorItem> TECTONIC_CREST_ARMOR_LEGGINGS = ITEMS.register("tectonic_crest_armor_leggings", () -> new TectonicCrestArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_TECTONIC)));
    public static final RegistryObject<TectonicCrestArmorItem> TECTONIC_CREST_ARMOR_BOOTS = ITEMS.register("tectonic_crest_armor_boots", () -> new TectonicCrestArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_TECTONIC)));
    public static final RegistryObject<CursedWraithguardArmorItem> CURSED_WRAITHGUARD_ARMOR_CROWN = ITEMS.register("cursed_wraithguard_crown", () -> new CursedWraithguardArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_CURSED)));
    public static final RegistryObject<CursedWraithguardArmorItem> CURSED_WRAITHGUARD_ARMOR_CHESTPLATE = ITEMS.register("cursed_wraithguard_chestplate", () -> new CursedWraithguardArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_CURSED)));
    public static final RegistryObject<CursedWraithguardArmorItem> CURSED_WRAITHGUARD_ARMOR_SPECTRAL_WRAPPING = ITEMS.register("cursed_wraithguard_spectral_wrapping", () -> new CursedWraithguardArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_CURSED)));
    public static final RegistryObject<CursedWraithguardArmorItem> CURSED_WRAITHGUARD_ARMOR_BOOTS = ITEMS.register("cursed_wraithguard_boots", () -> new CursedWraithguardArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_CURSED)));
    public static final RegistryObject<DeeplingMageArmorItem> DEEPLING_MAGE_ARMOR_HELMET = ITEMS.register("deepling_mage_armor_helmet", () -> new DeeplingMageArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_AQUATIC)));
    public static final RegistryObject<DeeplingMageArmorItem> DEEPLING_MAGE_ARMOR_ROBE = ITEMS.register("deepling_mage_armor_robe", () -> new DeeplingMageArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_AQUATIC)));
    public static final RegistryObject<DeeplingMageArmorItem> DEEPLING_MAGE_ARMOR_LEGGINGS = ITEMS.register("deepling_mage_armor_leggings", () -> new DeeplingMageArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_AQUATIC)));
    public static final RegistryObject<DeeplingMageArmorItem> DEEPLING_MAGE_ARMOR_BOOTS = ITEMS.register("deepling_mage_armor_boots", () -> new DeeplingMageArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_AQUATIC)));
    public static final RegistryObject<MechanizedExoskeletonArmorItem> MECHANIZED_EXOSKELETON_ARMOR_HELMET = ITEMS.register("mechanized_exoskeleton_helmet", () -> new MechanizedExoskeletonArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(RARITY_MECHANIZED)));
    public static final RegistryObject<MechanizedExoskeletonArmorItem> MECHANIZED_EXOSKELETON_ARMOR_CHESTPLATE = ITEMS.register("mechanized_exoskeleton_chestplate", () -> new MechanizedExoskeletonArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(RARITY_MECHANIZED)));
    public static final RegistryObject<MechanizedExoskeletonArmorItem> MECHANIZED_EXOSKELETON_ARMOR_LEGGINGS = ITEMS.register("mechanized_exoskeleton_leggings", () -> new MechanizedExoskeletonArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(RARITY_MECHANIZED)));
    public static final RegistryObject<MechanizedExoskeletonArmorItem> MECHANIZED_EXOSKELETON_ARMOR_BOOTS = ITEMS.register("mechanized_exoskeleton_boots", () -> new MechanizedExoskeletonArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(RARITY_MECHANIZED)));
    public static final RegistryObject<ForlornHarbingerArmorItem> FORLORN_HARBINGER_ARMOR_HOOD = ITEMS.register("forlorn_harbinger_hood", () -> new ForlornHarbingerArmorItem(ArmorItem.Type.HELMET, new Item.Properties().m_41497_(ACItemRegistry.RARITY_DEMONIC)));
    public static final RegistryObject<ForlornHarbingerArmorItem> FORLORN_HARBINGER_ARMOR_ROBE = ITEMS.register("forlorn_harbinger_robe", () -> new ForlornHarbingerArmorItem(ArmorItem.Type.CHESTPLATE, new Item.Properties().m_41497_(ACItemRegistry.RARITY_DEMONIC)));
    public static final RegistryObject<ForlornHarbingerArmorItem> FORLORN_HARBINGER_ARMOR_LEGGINGS = ITEMS.register("forlorn_harbinger_leggings", () -> new ForlornHarbingerArmorItem(ArmorItem.Type.LEGGINGS, new Item.Properties().m_41497_(ACItemRegistry.RARITY_DEMONIC)));
    public static final RegistryObject<ForlornHarbingerArmorItem> FORLORN_HARBINGER_ARMOR_BOOTS = ITEMS.register("forlorn_harbinger_boots", () -> new ForlornHarbingerArmorItem(ArmorItem.Type.BOOTS, new Item.Properties().m_41497_(ACItemRegistry.RARITY_DEMONIC)));
    public static final RegistryObject<Item> DUSKWOOD_BOOKSHELF = TravelopticsItems.block(TravelopticsBlocks.DUSKWOOD_BOOKSHELF);
    public static final RegistryObject<Item> OBSIDIAN_BOOKSHELF = TravelopticsItems.blockWithProperties(TravelopticsBlocks.OBSIDIAN_BOOKSHELF, new Item.Properties().m_41497_(Rarity.EPIC));
    ...
    private static RegistryObject<Item> block(RegistryObject<Block> block) {
        return ITEMS.register(block.getId().m_135815_(), () -> new BlockItem((Block)block.get(), new Item.Properties()));
    }

    private static RegistryObject<Item> blockWithProperties(RegistryObject<Block> block, Item.Properties props) {
        return ITEMS.register(block.getId().m_135815_(), () -> new BlockItem((Block)block.get(), props));
    }
