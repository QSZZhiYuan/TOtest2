...
extends AbstractUniqueSpell {
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        kobolediator.m_6034_(entity.m_20185_() + xOffset, entity.m_20186_(), entity.m_20189_() + zOffset);
        kobolediator.m_21204_().m_22146_(Attributes.f_22281_).m_22100_((double)this.getKobolediatorDamage(spellLevel, entity));
        kobolediator.m_21204_().m_22146_(Attributes.f_22276_).m_22100_((double)this.getKobolediatorHealth(spellLevel));
        kobolediator.m_21153_(kobolediator.m_21233_());
        kobolediator.m_6518_((ServerLevelAccessor)((ServerLevel)world), world.m_6436_(kobolediator.m_20097_()), MobSpawnType.MOB_SUMMONED, null, null);
        world.m_7967_((Entity)kobolediator);
        kobolediator.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.KOBOLEDIATOR_TIMER.get(), summonTime, 0, false, false, false));
        MagicManager.spawnParticles((Level)world, (ParticleOptions)((ParticleOptions)ModParticle.SANDSTORM.get()), (double)(entity.m_20185_() + xOffset), (double)(entity.m_20186_() + 2.5), (double)(entity.m_20189_() + zOffset), (int)45, (double)0.0, (double)0.0, (double)0.0, (double)0.03, (boolean)false);
        int effectAmplifier = 0;
        if (entity.m_21023_((MobEffect)TravelopticsEffects.KOBOLEDIATOR_TIMER.get())) {
            effectAmplifier += entity.m_21124_((MobEffect)TravelopticsEffects.KOBOLEDIATOR_TIMER.get()).m_19564_() + 1;
        }
        entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.KOBOLEDIATOR_TIMER.get(), summonTime, effectAmplifier, false, false, true));
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237110_((String)"ui.traveloptics.hp", (Object[])new Object[]{Float.valueOf(this.getKobolediatorHealth(spellLevel))}), Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{this.getKobolediatorDamageText(spellLevel, caster)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
}
