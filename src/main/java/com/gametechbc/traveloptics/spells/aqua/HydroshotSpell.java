...
extends AdvancedSpell {
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return TOGeneralUtils.buildAquaSpellInfo(0, true, Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{Utils.stringTruncation((double)this.getDamage(spellLevel, caster), (int)2)}), Component.m_237110_((String)"ui.traveloptics.slowness_amplifier", (Object[])new Object[]{Utils.stringTruncation((double)this.getSlowness(spellLevel), (int)2)}));
    }
}
