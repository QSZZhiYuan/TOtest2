...
extends AbstractSpell {
    ...
    public boolean checkPreCastConditions(Level level, int spellLevel, LivingEntity entity, MagicData playerMagicData) {
        if (entity.m_6069_() || entity.m_21255_()) {
            return true;
        }
        if (entity instanceof Player) {
            Player player = (Player)entity;
            if (!level.m_5776_()) {
                player.m_5661_((Component)Component.m_237115_((String)"spell.traveloptics.jet_steam.warning").m_130940_(ChatFormatting.RED), true);
            }
        }
        return false;
    }
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        if (entity.m_21255_()) {
            entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.JET_STEAM.get(), this.getBoostDuration(spellLevel, entity), 0, false, false, false));
        }
        if (entity.m_6069_()) {
            entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.JET_STEAM.get(), this.getBoostDuration(spellLevel, entity) * 2, 0, false, false, false));
        }
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237115_((String)"ui.traveloptics.boost_duration"), Component.m_237110_((String)"ui.traveloptics.elytra_boost_duration", (Object[])new Object[]{Utils.timeFromTicks((float)this.getBoostDuration(spellLevel, caster), (int)2)}), Component.m_237110_((String)"ui.traveloptics.swimming_boost_duration", (Object[])new Object[]{Utils.timeFromTicks((float)(this.getBoostDuration(spellLevel, caster) * 2), (int)2)}), Component.m_237110_((String)"ui.traveloptics.recast", (Object[])new Object[]{Utils.stringTruncation((double)5.0, (int)2)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
