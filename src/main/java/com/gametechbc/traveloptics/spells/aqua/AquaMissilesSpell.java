...
extends AbstractSpell {
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return TOGeneralUtils.buildAquaSpellInfo(1, true, Component.m_237110_((String)"ui.traveloptics.multi_hit_aoe_damage", (Object[])new Object[]{Utils.stringTruncation((double)this.getDamage(spellLevel, caster), (int)2)}), Component.m_237110_((String)"ui.traveloptics.seeking_distance", (Object[])new Object[]{Utils.stringTruncation((double)this.getSeekingDistance(spellLevel), (int)2)}), Component.m_237110_((String)"ui.traveloptics.aoe_radius", (Object[])new Object[]{Utils.stringTruncation((double)this.getAoeRadius(), (int)2)}));
    }
}
