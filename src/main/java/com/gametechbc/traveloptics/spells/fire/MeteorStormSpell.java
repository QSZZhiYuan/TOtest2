...
extends AbstractSpell {
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        if (!entity.m_21023_((MobEffect)TravelopticsEffects.METEOR_STORM.get())) {
            entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.METEOR_STORM.get(), duration, damage));
        }
        if ((effectInstance = entity.m_21124_((MobEffect)TravelopticsEffects.METEOR_STORM.get())) != null && (mobEffect = effectInstance.m_19544_()) instanceof MeteorStormEffect) {
            MeteorStormEffect stormEffect = (MeteorStormEffect)mobEffect;
            stormEffect.setOuterRadius(radius);
        }
        MagicManager.spawnParticles((Level)level, (ParticleOptions)new BlastwaveParticleOptions(((SchoolType)SchoolRegistry.FIRE.get()).getTargetingColor(), (float)radius), (double)entity.m_20185_(), (double)(entity.m_20186_() + (double)0.165f), (double)entity.m_20189_(), (int)1, (double)0.0, (double)0.0, (double)0.0, (double)0.0, (boolean)true);
        SphereParticleManager.spawnParticles(level, (Entity)entity, 60, ParticleHelper.FIRE, ParticleDirection.OUTWARD, 3.5);
        ScreenShake_Entity.ScreenShake((Level)level, (Vec3)entity.m_20182_(), (float)((float)radius), (float)0.03f, (int)10, (int)20);
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        ...
        int duration = this.getDuration(spellLevel);
        return List.of(Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{Utils.stringTruncation((double)damage, (int)2)}), Component.m_237110_((String)"ui.traveloptics.radius", (Object[])new Object[]{Utils.stringTruncation((double)radius, (int)2)}), Component.m_237110_((String)"ui.traveloptics.meteor_storm_duration", (Object[])new Object[]{Utils.timeFromTicks((float)duration, (int)2)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
}
