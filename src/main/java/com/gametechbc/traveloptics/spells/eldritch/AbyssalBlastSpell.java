...
extends AbstractUniqueSpell {
    ...
    private void spawnAbyssBlastEntity(Level level, int spellLevel, LivingEntity caster) {
        ...
        level.m_7967_((Entity)abyssBlast);
    }

    private void applyCasterEffects(LivingEntity caster) {
        caster.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.FROZEN_SIGHT.get(), 100, 1, false, false, false));
    }
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        float getDamage = this.getDamage(spellLevel, caster);
        return List.of(Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{Utils.stringTruncation((double)getDamage, (int)2)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
