...
extends AbstractUniqueSpell {
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        for (int i = 0; i < tomeCount; ++i) {
            ...
            voidTome.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.VOID_TOME_TIMER.get(), summonTime, 0, false, false, false));
        ...
        if (entity.m_21023_((MobEffect)TravelopticsEffects.VOID_TOME_TIMER.get())) {
            effectAmplifier += entity.m_21124_((MobEffect)TravelopticsEffects.VOID_TOME_TIMER.get()).m_19564_() + 1;
        }
        entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.VOID_TOME_TIMER.get(), summonTime, effectAmplifier, false, false, true));
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237110_((String)"ui.traveloptics.summon_count", (Object[])new Object[]{this.getTomeCount()}), Component.m_237110_((String)"ui.traveloptics.hp", (Object[])new Object[]{Float.valueOf(this.getTomeHealth(spellLevel))}), Component.m_237110_((String)"ui.traveloptics.spell_power", (Object[])new Object[]{this.getTomeDamageText(spellLevel, caster)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
}
