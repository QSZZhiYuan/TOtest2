...
extends AbstractUniqueSpell {
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        enderGolem.m_6034_(entity.m_20185_() + xOffset, entity.m_20186_(), entity.m_20189_() + zOffset);
        enderGolem.m_21204_().m_22146_(Attributes.f_22281_).m_22100_((double)this.getGolemDamage(spellLevel, entity));
        enderGolem.m_21204_().m_22146_(Attributes.f_22276_).m_22100_((double)this.getGolemHealth(spellLevel));
        enderGolem.m_21153_(enderGolem.m_21233_());
        enderGolem.m_6518_((ServerLevelAccessor)((ServerLevel)world), world.m_6436_(enderGolem.m_20097_()), MobSpawnType.MOB_SUMMONED, null, null);
        world.m_7967_((Entity)enderGolem);
        enderGolem.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.ENDER_GOLEM_TIMER.get(), summonTime, 0, false, false, false));
        MagicManager.spawnParticles((Level)world, (ParticleOptions)ParticleTypes.f_123789_, (double)(entity.m_20185_() + xOffset), (double)(entity.m_20186_() + 2.0), (double)(entity.m_20189_() + zOffset), (int)50, (double)0.0, (double)0.0, (double)0.0, (double)0.03, (boolean)false);
        int effectAmplifier = 0;
        if (entity.m_21023_((MobEffect)TravelopticsEffects.ENDER_GOLEM_TIMER.get())) {
            effectAmplifier += entity.m_21124_((MobEffect)TravelopticsEffects.ENDER_GOLEM_TIMER.get()).m_19564_() + 1;
        }
        entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.ENDER_GOLEM_TIMER.get(), summonTime, effectAmplifier, false, false, true));
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237110_((String)"ui.traveloptics.hp", (Object[])new Object[]{Float.valueOf(this.getGolemHealth(spellLevel))}), Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{this.getGolemDamageText(spellLevel, caster)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
}
