...
extends AbstractUniqueSpell {
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        aptrgangr.m_6034_(entity.m_20185_() + xOffset, entity.m_20186_(), entity.m_20189_() + zOffset);
        aptrgangr.m_21204_().m_22146_(Attributes.f_22281_).m_22100_((double)this.getAptrgangrDamage(spellLevel, entity));
        aptrgangr.m_21204_().m_22146_(Attributes.f_22276_).m_22100_((double)this.getAptrgangrHealth(spellLevel));
        aptrgangr.m_21153_(aptrgangr.m_21233_());
        aptrgangr.m_6518_((ServerLevelAccessor)((ServerLevel)world), world.m_6436_(aptrgangr.m_20097_()), MobSpawnType.MOB_SUMMONED, null, null);
        world.m_7967_((Entity)aptrgangr);
        aptrgangr.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.APTRGANGR_TIMER.get(), summonTime, 0, false, false, false));
        MagicManager.spawnParticles((Level)world, (ParticleOptions)((ParticleOptions)ModParticle.CURSED_FLAME.get()), (double)(entity.m_20185_() + xOffset), (double)(entity.m_20186_() + 2.5), (double)(entity.m_20189_() + zOffset), (int)45, (double)0.0, (double)0.0, (double)0.0, (double)0.03, (boolean)false);
        int effectAmplifier = 0;
        if (entity.m_21023_((MobEffect)TravelopticsEffects.APTRGANGR_TIMER.get())) {
            effectAmplifier += entity.m_21124_((MobEffect)TravelopticsEffects.APTRGANGR_TIMER.get()).m_19564_() + 1;
        }
        entity.m_7292_(new MobEffectInstance((MobEffect)TravelopticsEffects.APTRGANGR_TIMER.get(), summonTime, effectAmplifier, false, false, true));
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237110_((String)"ui.traveloptics.hp", (Object[])new Object[]{Float.valueOf(this.getAptrgangrHealth(spellLevel))}), Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{this.getAptrgangrDamageText(spellLevel, caster)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
}
