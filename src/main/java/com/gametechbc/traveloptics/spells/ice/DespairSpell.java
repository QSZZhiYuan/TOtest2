...
extends AbstractSpell {
    ...
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(Component.m_237110_((String)"ui.traveloptics.damage", (Object[])new Object[]{Utils.stringTruncation((double)this.getDamage(spellLevel, caster), (int)2)}), Component.m_237110_((String)"ui.traveloptics.recast", (Object[])new Object[]{Utils.stringTruncation((double)this.getRecastCount(spellLevel, caster), (int)2)}), Component.m_237113_((String)"\u00a79T.O Magic 'n Extras"));
    }
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        if (!hasRingEquipped) {
            lookVector = new Vec3(lookVector.f_82479_, 0.0, lookVector.f_82481_).m_82541_();
        }
        float damage = this.getDamage(spellLevel, entity);
        Axe_Blade_Entity axeBlade = new Axe_Blade_Entity(entity, lookVector.f_82479_, lookVector.f_82480_, lookVector.f_82481_, level, damage, entity.m_146908_());
        axeBlade.m_20256_(lookVector.m_82490_(speedMultiplier));
        level.m_7967_((Entity)axeBlade);
