...
extends AbstractImbuableArmorItem {
    ...
    private void triggerKnockbackAndDamage(Player player) {
        ...
        List nearbyEntities = level.m_6443_(LivingEntity.class, boundingBox, entity -> {
            ...
            return !(entity instanceof TamableAnimal) || !(tamable = (TamableAnimal)entity).m_21824_() || tamable.m_269323_() != player;
        });
    ...
    private void setCooldownOnChestplate(Player player) {
        ...
        if (chestplate.m_41720_() instanceof PrimordialCrestArmorItem) {
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.primordial_crest_armor.tooltip").m_130940_(ChatFormatting.GREEN));
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.primordial_crest_armor.tooltip1"));
    ...
    private boolean isWearingFullSet(Player player) {
        return player.m_6844_(ArmorItem.Type.HELMET.m_266308_()).m_41720_() instanceof PrimordialCrestArmorItem && player.m_6844_(ArmorItem.Type.CHESTPLATE.m_266308_()).m_41720_() instanceof PrimordialCrestArmorItem && player.m_6844_(ArmorItem.Type.LEGGINGS.m_266308_()).m_41720_() instanceof PrimordialCrestArmorItem && player.m_6844_(ArmorItem.Type.BOOTS.m_266308_()).m_41720_() instanceof PrimordialCrestArmorItem;
    }
