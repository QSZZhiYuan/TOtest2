...
extends BaseWeaponAbility {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag, int type) {
        ...
        if (type == 0) {
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip").m_130940_(ChatFormatting.DARK_GREEN));
            tooltip.add((Component)Component.m_237115_((String)"ui.traveloptics.weapon.evolution_zero").m_130940_(ChatFormatting.YELLOW));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip1"));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_one.inactive.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_two.inactive.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_three.inactive.tooltip"));
            } else {
        ...
        if (type == 1) {
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip2"));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_one.active.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_two.inactive.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_three.inactive.tooltip"));
            } else {
        ...
        if (type == 2) {
            ...
            if (currentForm == 0) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip.manifestation0").m_130940_(ChatFormatting.LIGHT_PURPLE));
            } else if (currentForm == 1) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip.manifestation1").m_130940_(ChatFormatting.LIGHT_PURPLE));
            }
            if (currentForm == 0) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip5"));
            } else if (currentForm == 1) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip3"));
            }
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_one.active.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_two.active.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_three.inactive.tooltip"));
            } else {
        ...
        if (type == 3) {
            ...
            if (currentForm == 0) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip6"));
            } else if (currentForm == 1) {
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.tooltip4"));
            }
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_one.active.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_two.active.tooltip"));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.scourge_of_the_sands.evo_three.active.tooltip"));
            } else {
