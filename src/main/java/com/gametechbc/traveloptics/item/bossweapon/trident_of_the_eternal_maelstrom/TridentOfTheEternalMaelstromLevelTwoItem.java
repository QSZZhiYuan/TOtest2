...
public class TridentOfTheEternalMaelstromLevelTwoItem
extends TridentOfTheEternalMaelstromLevelOneItem {
    private static ItemDisplayContext transformType;

    public TridentOfTheEternalMaelstromLevelTwoItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.trident_of_the_eternal_maelstrom.tooltip3"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
