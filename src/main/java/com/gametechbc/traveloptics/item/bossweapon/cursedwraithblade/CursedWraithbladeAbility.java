...
extends BaseWeaponAbility {
    ...
    public void appendHoverText(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag, int type) {
        if (type == 0) {
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip").m_130940_(ChatFormatting.GREEN));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip1"));
            tooltip.add((Component)Component.m_237113_((String)("\u2620 Soul Fragments: " + SpiritPointsManager.getSpiritPoints(stack))).m_130940_(ChatFormatting.GOLD));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
        ...
        if (type == 1) {
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip").m_130940_(ChatFormatting.GREEN));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip2"));
            tooltip.add((Component)Component.m_237113_((String)("\u2620 Soul Fragments: " + SpiritPointsManager.getSpiritPoints(stack))).m_130940_(ChatFormatting.GOLD));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
        ...
        if (type == 2) {
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip").m_130940_(ChatFormatting.GREEN));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip3"));
            tooltip.add((Component)Component.m_237113_((String)("\u2620 Soul Fragments: " + SpiritPointsManager.getSpiritPoints(stack))).m_130940_(ChatFormatting.GOLD));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
        ...
        if (type == 3) {
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip").m_130940_(ChatFormatting.GREEN));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.cursed_wraithblade.tooltip4"));
            tooltip.add((Component)Component.m_237113_((String)("\u2620 Soul Fragments: " + SpiritPointsManager.getSpiritPoints(stack))).m_130940_(ChatFormatting.GOLD));
            if (Screen.m_96638_()) {
                tooltip.add((Component)Component.m_237113_((String)""));
                tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
