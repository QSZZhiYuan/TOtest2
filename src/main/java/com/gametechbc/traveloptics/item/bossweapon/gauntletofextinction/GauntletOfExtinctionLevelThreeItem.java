...
public class GauntletOfExtinctionLevelThreeItem
extends GauntletOfExtinctionLevelTwoItem
implements UniqueItem {
    private static ItemDisplayContext transformType;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache((GeoAnimatable)this);

    public GauntletOfExtinctionLevelThreeItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(imbuedSpells);
    ...
    protected int calculateSpiritDamageAmplifier(LivingEntity player) {
        ...
        return (int)((double)((int)(attackDamage * 0.5)) * (Double)WeaponConfig.gauntletOfExtinctionPrimevalDevourDamageMultiplier.get());
    }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.gauntlet_of_extinction.tooltip2"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.gauntlet_of_extinction.evo_one.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.gauntlet_of_extinction.evo_two.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.gauntlet_of_extinction.evo_three.active.tooltip"));
        } else {
