...
public class InfernalDevastatorLevelThreeItem
extends InfernalDevastatorLevelTwoItem
implements UniqueItem {
    private static ItemDisplayContext transformType;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache((GeoAnimatable)this);

    public InfernalDevastatorLevelThreeItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(imbuedSpells);
    ...
    protected float calculateFlameDamage(LivingEntity player) {
        ...
        float baseDamage = (float)(20.0 * (Double)WeaponConfig.infernalDevastatorBlazingSalvoDamageMultiplier.get());
        return baseDamage * (float)(1.0 + fireSpellPower * 0.5);
    }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.infernal_devastator.tooltip2"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.infernal_devastator.evo_one.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.infernal_devastator.evo_two.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.infernal_devastator.evo_three.active.tooltip"));
        } else {
