...
public class HarbingersWrathLevelOneItem
extends MagicClaymoreItem {
    public HarbingersWrathLevelOneItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)"\u00a7fSuccessful hits on enemies has \u00a7b15% \u00a7fchance to stun them with a mini EM-Pulse, for \u00a7b3.5 sec."));
