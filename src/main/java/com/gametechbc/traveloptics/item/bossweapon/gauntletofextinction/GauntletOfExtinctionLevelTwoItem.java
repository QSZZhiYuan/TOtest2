...
public class GauntletOfExtinctionLevelTwoItem
extends GauntletOfExtinctionLevelOneItem
implements UniqueItem {
    private static ItemDisplayContext transformType;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache((GeoAnimatable)this);

    public GauntletOfExtinctionLevelTwoItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(imbuedSpells);
