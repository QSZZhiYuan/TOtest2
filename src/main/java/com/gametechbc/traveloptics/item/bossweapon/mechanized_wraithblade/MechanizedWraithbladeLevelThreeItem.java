...
public class MechanizedWraithbladeLevelThreeItem
extends MechanizedWraithbladeItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache((GeoAnimatable)this);

    public MechanizedWraithbladeLevelThreeItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(imbuedSpells);
    ...
    protected float calculateFinalLaserDamage(float baseDamage, LivingEntity entity) {
        Attribute lightningSpellPower = (Attribute)AttributeRegistry.LIGHTNING_SPELL_POWER.get();
        double spellPowerMultiplier = entity.m_21133_(lightningSpellPower);
        return baseDamage * (float)(0.5 + 0.5 * Math.sqrt(spellPowerMultiplier));
    }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.mechanized_wraithblade.tooltip2"));
        ...
        if (Screen.m_96638_()) {
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.mechanized_wraithblade.evo_one.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.mechanized_wraithblade.evo_two.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.mechanized_wraithblade.evo_three.active.tooltip"));
            tooltip.add((Component)Component.m_237113_((String)""));
