...
public class InfernalDevastatorLevelTwoItem
extends InfernalDevastatorLevelOneItem
implements UniqueItem {
    private static ItemDisplayContext transformType;
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache((GeoAnimatable)this);

    public InfernalDevastatorLevelTwoItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(imbuedSpells);
