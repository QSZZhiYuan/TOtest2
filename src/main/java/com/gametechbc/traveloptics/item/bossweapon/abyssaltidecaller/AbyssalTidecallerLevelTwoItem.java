...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.evo_two.AbyssalTidecallerLevelTwoRenderer;
...
public class AbyssalTidecallerLevelTwoItem
extends UnbreakableGeoMagicSword {
    ...
    public AbyssalTidecallerLevelTwoItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public boolean m_7579_(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (target != null && attacker.m_217043_().m_188501_() < 0.6f && (abyssalCurseEffect = (MobEffect)ModEffect.EFFECTABYSSAL_CURSE.get()) != null) {
            int currentAmplifier;
            MobEffectInstance currentEffect = target.m_21124_(abyssalCurseEffect);
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new AbyssalTidecallerLevelTwoRenderer();
    }
