...
extends UnbreakableGeoMagicSword {
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.tooltip4"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
            ...
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.evo_three.active.tooltip"));
        } else {
