...
import com.gametechbc.traveloptics.entity.item.abyssal_tidecaller.base.AbyssalTidecallerRenderer;
...
public class AbyssalTidecallerItem
extends UnbreakableGeoMagicSword {
    ...
    public AbyssalTidecallerItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public boolean m_7579_(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (target != null && attacker.m_217043_().m_188501_() < 0.4f && (abyssalCurseEffect = (MobEffect)ModEffect.EFFECTABYSSAL_CURSE.get()) != null) {
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new AbyssalTidecallerRenderer();
    }
