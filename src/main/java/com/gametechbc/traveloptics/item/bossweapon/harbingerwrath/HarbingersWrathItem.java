...
public class HarbingersWrathItem
extends MagicClaymoreItem {
    public HarbingersWrathItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public boolean m_7579_(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (target != null && attacker.m_217043_().m_188501_() < 0.15f && (stunEffect = (MobEffect)ModEffect.EFFECTSTUN.get()) != null && (currentEffect = target.m_21124_(stunEffect)) == null) {
            target.m_7292_(new MobEffectInstance(stunEffect, 40, 0));
        }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)"\u00a7fSuccessful hits on enemies has \u00a7b15% \u00a7fchance to stun them with a mini EM-Pulse, for \u00a7b2 sec."));
            ...
            tooltip.add((Component)Component.m_237113_((String)"\u00a77\u2606 [Evo 1] Increases effect duration \u00a73+1.5 sec."));
            tooltip.add((Component)Component.m_237113_((String)"\u00a77\u2606 [Evo 2] Increases proc chance \u00a73+10%."));
