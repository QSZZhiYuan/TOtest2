...
import com.gametechbc.traveloptics.entity.item.thorns_of_oblivion.base.ThornsOfOblivionRenderer;
...
public class ThornsOfOblivionItem
extends UnbreakableGeoMagicSword {
    private static ItemDisplayContext transformType;
    private int swingCounter = 0;

    public ThornsOfOblivionItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)"\u00a7fEvery \u00a7b7th \u00a7fhit guarantees \u00a7b12 \u00a7fAmethyst Cluster Projectiles, launching in every direction."));
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237113_((String)"\u00a7eEvolution Benefits:"));
            tooltip.add((Component)Component.m_237113_((String)"\u00a77\u2606 [Evo 1] Decreases swing counter to activate the ability \u00a73-2."));
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new ThornsOfOblivionRenderer();
    }
}
