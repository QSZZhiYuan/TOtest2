...
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_two.FlamesOfEldritchLevelTwoRenderer;
...
public class FlamesOfEldritchLevelTwoItem
extends UnbreakableGeoMagicSword {
    private static ItemDisplayContext transformType;

    public FlamesOfEldritchLevelTwoItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public boolean m_7579_(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        if (target != null && attacker.m_217043_().m_188501_() < 0.6f && (blazingBrandEffect = (MobEffect)ModEffect.EFFECTBLAZING_BRAND.get()) != null) {
            ...
            if (currentAmplifier >= 0) {
                int newAmplifier = 0;
                target.m_7292_(new MobEffectInstance(blazingBrandEffect, 100, newAmplifier));
            } else {
                target.m_7292_(new MobEffectInstance(blazingBrandEffect, 100, 0));
            }
        }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.tooltip3"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.weapons.evolution_benefits.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.evo_one.active.tooltip"));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.evo_two.active.tooltip"));
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new FlamesOfEldritchLevelTwoRenderer();
    }
}
