...
import com.gametechbc.traveloptics.entity.item.flames_of_eldritch.evo_one.FlamesOfEldritchLevelOneRenderer;
...
public class FlamesOfEldritchLevelOneItem
extends UnbreakableGeoMagicSword {
    private static ItemDisplayContext transformType;

    public FlamesOfEldritchLevelOneItem(SpellDataRegistryHolder[] imbuedSpells) {
        super(new Tier(){
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.flames_of_eldritch.tooltip2"));
        if (Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237113_((String)""));
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new FlamesOfEldritchLevelOneRenderer();
    }
}
