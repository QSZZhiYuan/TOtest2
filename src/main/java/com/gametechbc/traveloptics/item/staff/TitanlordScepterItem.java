...
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.base.TitanlordScepterRenderer;
...
extends GeoStaffItem {
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new TitanlordScepterRenderer();
    }
}
