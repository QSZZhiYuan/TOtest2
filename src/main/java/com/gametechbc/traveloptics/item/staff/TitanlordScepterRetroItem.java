...
import com.gametechbc.traveloptics.entity.item.titanlord_scepter.retro.TitanlordScepterRetroRenderer;
...
extends GeoStaffItem {
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new TitanlordScepterRetroRenderer();
    }
}
