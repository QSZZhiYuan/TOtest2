...
extends AdvancedEchoCurio {
    ...
    protected Component getUnassignedHoverText() {
        return Component.m_237115_((String)"item.traveloptics.random_imbue_curio.evocation_unassigned.tooltip");
    }

    @Override
    protected Component getAssignedHoverText() {
        return Component.m_237115_((String)"item.traveloptics.random_imbue_curio.evocation_assigned.tooltip").m_130940_(ChatFormatting.DARK_GREEN);
    }
