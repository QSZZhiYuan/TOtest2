...
extends Item {
    public PlasmaPowerCellItem() {
        super(new Item.Properties().m_41487_(64).m_41497_(TravelopticsItems.RARITY_MECHANIZED));
    }
    ...
    public void m_7373_(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        if (!Screen.m_96638_()) {
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.plasma_power_cell.desc").m_130940_(ChatFormatting.DARK_GREEN));
            tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.plasma_power_cell.desc4").m_130940_(ChatFormatting.DARK_GRAY));
            return;
        }
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.plasma_power_cell.desc").m_130940_(ChatFormatting.DARK_GREEN));
        tooltip.add((Component)Component.m_237113_((String)""));
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.plasma_power_cell.desc2").m_130940_(ChatFormatting.GOLD));
        tooltip.add((Component)Component.m_237113_((String)("\u2192 " + this.getNativeSupportedText())).m_130940_(ChatFormatting.GRAY));
        tooltip.add((Component)Component.m_237113_((String)""));
        tooltip.add((Component)Component.m_237115_((String)"item.traveloptics.plasma_power_cell.desc3").m_130940_(ChatFormatting.GOLD));
        tooltip.add((Component)Component.m_237113_((String)("\u2192 " + this.getPartiallySupportedText())).m_130940_(ChatFormatting.GRAY));
    }
