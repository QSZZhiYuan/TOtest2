...
extends RecordItem {
    public MusicDiscEldritchAbyssamorphItem() {
        super(15, () -> (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("traveloptics:eldritch_abyssamorph")), new Item.Properties().m_41487_(1).m_41497_(Rarity.EPIC), 2020);
    }
}
