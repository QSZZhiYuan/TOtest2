...
public class PrimordialCrestOverlay {
    ...
    public static void onRenderOverlay(RenderGuiOverlayEvent.Post event) {
        ...
        if (USE_XP_BAR) {
            ...
            poseStack.m_85836_();
            guiGraphics.m_280163_(PRIMORDIAL_CREST_TEXTURE, x, y, 29.0f, 89.0f, 182, 5, 241, 115);
            int fillWidth = (int)(182.0 * (1.0 - progress));
            if (fillWidth > 0) {
                guiGraphics.m_280163_(PRIMORDIAL_CREST_TEXTURE, x, y, 29.0f, 99.0f, fillWidth, 5, 241, 115);
            }
            poseStack.m_85849_();
        } else {
            int barWidth = 135;
            ...
            guiGraphics.m_280163_(PRIMORDIAL_CREST_TEXTURE, 0, 0, 53.0f, 20.0f, 135, 25, 241, 115);
            int fillWidth = (int)(135.0 * (1.0 - progress));
            if (fillWidth > 0) {
                guiGraphics.m_280163_(PRIMORDIAL_CREST_TEXTURE, 0, 0, 53.0f, 48.0f, fillWidth, 25, 241, 115);
            }
            poseStack.m_85849_();
        }
    }
    ...
    public static void onRenderXpBar(RenderGuiOverlayEvent.Pre event) {
        ...
        ItemStack chestplate = player.m_6844_(EquipmentSlot.CHEST);
        if (chestplate.m_41619_() || chestplate.m_41720_() != TravelopticsItems.PRIMORDIAL_CREST_ARMOR_CHESTPLATE.get()) {
            return;
        }
        if (USE_XP_BAR) {
            if (!shouldRenderFuelBar) {
