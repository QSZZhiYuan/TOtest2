...
public class PurpleStarInwardParticle
extends TextureSheetParticle {
    private final SpriteSet sprites;

    public PurpleStarInwardParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
            return new PurpleStarInwardParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
